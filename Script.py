class script(object):  
    START_TXT = """<b>𝙃𝙚𝙮 {user}😃
    
𝙎𝙩𝙖𝙧𝙩 𝙮𝙤𝙪𝙧 𝙖𝙙𝙫𝙚𝙣𝙩𝙪𝙧𝙚 𝙬𝙞𝙩𝙝 𝙤𝙪𝙧 𝙫𝙖𝙨𝙩 𝙖𝙧𝙧𝙖𝙮 𝙤𝙛 𝙚𝙣𝙘𝙝𝙖𝙣𝙩𝙞𝙣𝙜 𝘼𝙪𝙙𝙞𝙤𝙗𝙤𝙤𝙠𝙨 𝙖𝙣𝙙 𝙀𝙗𝙤𝙤𝙠𝙨\n\n𝙒𝙧𝙞𝙩𝙚 𝙙𝙤𝙬𝙣 𝙮𝙤𝙪𝙧 𝙙𝙚𝙨𝙞𝙧𝙚 𝘼𝙪𝙙𝙞𝙤𝙗𝙤𝙤𝙠𝙨, 𝙀𝙗𝙤𝙤𝙠𝙨 𝙣𝙖𝙢𝙚 𝙬𝙞𝙩𝙝 𝙥𝙧𝙤𝙥𝙚𝙧 𝙨𝙥𝙚𝙡𝙡 𝙖𝙣𝙙 𝙝𝙞𝙩 ✨</b>"""
...
Fʀᴇᴇ Dɪꜱᴋ: {}"""
    ...
    FORCE_SUB_TEXT = "𝘿𝙤𝙣'𝙩 𝙢𝙞𝙨𝙨 𝙤𝙪𝙩 𝙤𝙥𝙥𝙤𝙧𝙩𝙪𝙣𝙞𝙩𝙮 𝙩𝙤 𝙟𝙤𝙞𝙣 𝙤𝙪𝙧 𝙘𝙝𝙖𝙣𝙣𝙚𝙡 𝙩𝙤 𝙘𝙤𝙣𝙣𝙚𝙘𝙩 𝙬𝙞𝙩𝙝 𝙛𝙚𝙡𝙡𝙤𝙬 𝙧𝙚𝙖𝙙𝙚𝙧𝙨 𝙖𝙣𝙙 𝙖𝙘𝙘𝙚𝙨𝙨 𝙖𝙢𝙖𝙯𝙞𝙣𝙜 𝙩𝙝𝙞𝙨 𝙗𝙤𝙩 !"
   
    WELCOM_TEXT = """𝙃𝙚𝙮 {user} 👀
