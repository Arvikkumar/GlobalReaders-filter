...
auth_channel = environ.get('AUTH_CHANNEL', '-1002022145293')
auth_grp = environ.get('AUTH_GROUP', '-1001995627393')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+GzPIf8zRjiRhYmFh')
