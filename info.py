...
PICS = (environ.get('PICS' ,'https://graph.org/file/3885d663a3160428432d5.jpg')).split()
UPTIME = time.time()
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS','-1001779709248').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL', '-1002042588405')
auth_grp = environ.get('AUTH_GROUP','-1002140759780')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', 'mongodb+srv://arvik8099:Rronb0XWHfsg0e0p@cluster0.w7orjsc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0')
...
WELCOM_PIC = environ.get("WELCOM_PIC", "https://graph.org/file/3885d663a3160428432d5.jpg")
